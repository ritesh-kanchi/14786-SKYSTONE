...
robot.left
@Autonomous(name = "BlueObject")
// @Disabled
public class BlueObject extends LinearOpMode {
          ...
          if (updatedRecognitions != null) {
            ...
            for (Recognition recognition : updatedRecognitions) {
              ...
              if (recognition.getLabel() == "Skystone") {
                ...
                if (100 <= midH && midH <= 150 && 50 <= midV && midV <= 170) {
                  ...
                  encoderDrive(0.3,40,1.0);
                  gap();
                  encoderStrafe(.3,10.75,1.0);
                  gap();
                  encoderDrive(.4,6,1.0);
                  sleep(250);
                  encoderDrive(0.3, -14, 1.0);
                  setHeading();
                  encoderDrive(0.3, -14.25, 1.0);
                  ...
                  encoderDrive(0.3, 15, 1.0);
                  gap();
                  encoderStrafe(.75, 125, 1.0);
                  encoderStrafe(.75, 15, 1.0);
                  setHeading();
                  robot.upRight();
                    encoderDrive(.3,5,1.0);
                   gap();

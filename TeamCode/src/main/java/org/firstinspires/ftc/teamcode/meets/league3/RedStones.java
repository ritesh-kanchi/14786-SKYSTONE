            ...
            for (Recognition recognition : updatedRecognitions) {
              ...
              if (recognition.getLabel() == "Skystone") {
                ...
                if (midH <= 215) {
                  ...
                  path.firstSkystoneRed("Left", -5, path.acrossFieldRight -3);
                  ...
                  // Get's the first Skystone
                  path.firstSkystoneRed("Center", 6, path.acrossFieldRight - 5);
                  // Outtake's the first Skystone and goes to get second
                  path.outtakeRed(71);
                  // Get's the second Skystone
                  ...
                  move.encoderStrafe(path.strafePower, 26, 1.0);
                  ...
                  move.turn(path.angleToStoneRed - addedValue);
                  // Turn on Intake
                  move.intake("in");
                  sleep(400);
                  // Drive forward to get Skystone
                  move.driveForward(path.normalPower, path.forBack, path.angleToStoneRedF - addedValue);
                  // Turn off Intake
                  move.intake("stop");
                  // Back up
                  move.driveBackward(path.normalPower, path.forBack - addedValue, path.angleToStoneRedF - addedValue);
                  path.gap();
                  // Turn to 90ish
                  move.turn(-87);
                  path.gap();
                  // Drive across tape
                  move.driveForward(path.normalPower, path.acrossFieldRight - 16, -87);
                  // Outtake's the first Skystone and goes to get second
                  path.outtakeRed(61);
                  // Get's the second Skystone

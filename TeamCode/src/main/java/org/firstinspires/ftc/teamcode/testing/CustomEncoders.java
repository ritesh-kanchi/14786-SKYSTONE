...
@Autonomous(name = "CustomEncoders")
//@Disabled
public class CustomEncoders extends LinearOpMode {

    HardwareRobot robot = new HardwareRobot();
    
    // tick count for a REV 20:1 HD HEX
    static final int MOTOR_TICKS_COUNT = 392;
    ...
    public void encoderMove(double inches, double power) {
        ...
        double circumference = 3.14159265 * MOTOR_DIAMETER; // pi * diameter
        
        
        double rotations = inches / circumference;
        
        // encoders only take integer tick counts
        int encoderDrivingTarget = (int)(rotations * MOTOR_TICKS_COUNT);

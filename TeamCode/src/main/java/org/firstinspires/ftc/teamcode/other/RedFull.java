...
public class RedFull extends LinearOpMode {
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        for (Recognition recognition : updatedRecognitions) {
                            ...
                            if (recognition.getLabel().equals(LABEL_SECOND_ELEMENT)) {
                                ...
                                position = "BACKUP";
                                position = "Center";
                                redPath(position, 6, 50, 229 * 2, 60);
                            }
                        }
                        telemetry.update();
                    }
    ...
    public void redPath(String skystone, double strafeInches, double forDist, double mmBack, double backDist) {
        ...
        //move.turn(-90);
        move.turn(90);
         move.distance("backwards", 0.6, 750, 90, 200, robot.backDist);
         move.turn(180);
        ...
        sleep(400);
        move.turn(-90);
        move.forward(0.6,20,0);
        move.turn(-180);
        sleep(50000);
        move.distance("backwards", 0.6, 1250, -80, mmBack, robot.backDist);
        move.turn(35);
        robot.intake("in");
